...
#include "stanExports_student_mixture.h"

RCPP_MODULE(stan_fit4student_mixture_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_student_mixture")
