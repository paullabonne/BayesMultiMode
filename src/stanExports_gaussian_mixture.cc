...
#include "stanExports_gaussian_mixture.h"

RCPP_MODULE(stan_fit4gaussian_mixture_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_gaussian_mixture")
