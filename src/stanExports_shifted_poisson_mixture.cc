...
#include "stanExports_shifted_poisson_mixture.h"

RCPP_MODULE(stan_fit4shifted_poisson_mixture_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_shifted_poisson_mixture")
