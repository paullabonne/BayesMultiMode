...
namespace model_poisson_mixture_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'poisson_mixture', line 12, column 2 to column 19)",
                                                      " (in 'poisson_mixture', line 13, column 2 to column 29)",
                                                      " (in 'poisson_mixture', line 14, column 2 to column 40)",
                                                      " (in 'poisson_mixture', line 17, column 9 to column 10)",
                                                      " (in 'poisson_mixture', line 17, column 2 to column 35)",
                                                      " (in 'poisson_mixture', line 22, column 4 to column 29)",
                                                      " (in 'poisson_mixture', line 23, column 4 to column 47)",
                                                      " (in 'poisson_mixture', line 21, column 9 to line 24, column 3)",
                                                      " (in 'poisson_mixture', line 20, column 4 to column 41)",
                                                      " (in 'poisson_mixture', line 19, column 10 to line 21, column 3)",
                                                      " (in 'poisson_mixture', line 19, column 2 to line 24, column 3)",
                                                      " (in 'poisson_mixture', line 26, column 2 to column 25)",
                                                      " (in 'poisson_mixture', line 29, column 11 to column 12)",
                                                      " (in 'poisson_mixture', line 29, column 4 to column 30)",
                                                      " (in 'poisson_mixture', line 31, column 6 to column 46)",
                                                      " (in 'poisson_mixture', line 30, column 19 to line 32, column 5)",
                                                      " (in 'poisson_mixture', line 30, column 4 to line 32, column 5)",
                                                      " (in 'poisson_mixture', line 33, column 4 to column 31)",
                                                      " (in 'poisson_mixture', line 28, column 17 to line 34, column 3)",
                                                      " (in 'poisson_mixture', line 28, column 2 to line 34, column 3)",
                                                      " (in 'poisson_mixture', line 2, column 2 to column 17)",
                                                      " (in 'poisson_mixture', line 3, column 2 to column 17)",
                                                      " (in 'poisson_mixture', line 4, column 8 to column 9)",
                                                      " (in 'poisson_mixture', line 4, column 2 to column 11)",
                                                      " (in 'poisson_mixture', line 5, column 2 to column 19)",
                                                      " (in 'poisson_mixture', line 6, column 2 to column 19)",
                                                      " (in 'poisson_mixture', line 7, column 2 to column 19)",
                                                      " (in 'poisson_mixture', line 8, column 2 to column 10)",
                                                      " (in 'poisson_mixture', line 9, column 2 to column 19)",
                                                      " (in 'poisson_mixture', line 12, column 10 to column 11)",
                                                      " (in 'poisson_mixture', line 13, column 19 to column 20)",
                                                      " (in 'poisson_mixture', line 14, column 18 to column 32)"};
...
public:
  ~model_poisson_mixture() { }
  
  inline std::string model_name() const final { return "model_poisson_mixture"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_poisson_mixture(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_poisson_mixture_namespace::model_poisson_mixture";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_poisson_mixture_namespace::log_prob";
(void) function__;  // suppress unused var warning
        ...
        for (int n = 1; n <= N; ++n) {
          ...
          for (int k = 1; k <= K; ++k) {
            ...
            assign(lps, cons_list(index_uni(k), nil_index_list()),
              (lps[(k - 1)] +
                poisson_lpmf<false>(y[(n - 1)], lambda[(k - 1)])),
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_poisson_mixture_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" << alpha_1dim__ << "},\"block\":\"parameters\"}]";
    return s__.str();
    } // get_constrained_sizedtypes() 
    
  inline std::string get_unconstrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" << (K - 1) << "},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" << alpha_1dim__ << "},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_poisson_mixture_namespace::model_poisson_mixture;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_poisson_mixture_namespace::profiles__;
}
#endif
#endif
