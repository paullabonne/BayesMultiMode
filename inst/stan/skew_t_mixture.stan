...
data {
  ...
  real<lower=0> G0;        // prior - variance 
  real<lower=0> n0;        // prior - tail parameters
  real<lower=0> N0;        // prior - tail parameters
  real h0;                 // prior - skewness
  real<lower=0> H0;        // prior - skewness 
}
...
parameters {
  ...
  vector<lower=1>[K] nu;                   // tail parameters
  real xi[K];                              // skewness parameters
